  ...
  <div id="mainContent" class="container my-5">
    <div class="row">
      <div class="col-lg-8">
        ...
        <!-- Profile -->
        <div id="profile" class="card-section animated-section" data-animate="slide-left">
          <h2>Jeremy Voegele</h2>
          <p class="text-white">IT & Mechanical Systems Technician | U.S. Navy Veteran | Linux & Cloud Enthusiast</p>
          <p>
        ...
        <!-- Work Experience -->
        <div id="work" class="card-section animated-section" data-animate="fade-scale">
        ...
        <div id="experience" class="card-section animated-section" data-animate="rotate-list">
        ...
        <!-- Volunteer -->
        <div id="volunteer" class="card-section animated-section" data-animate="rotate-list">
        ...
        <!-- Personal Projects -->
        <div id="projects" class="card-section animated-section" data-animate="rotate-list">
        ...
        <!-- Certifications -->
        <div id="certs" class="card-section animated-section" data-animate="glow-pulse">
        ...
        <!-- Education -->
        <div id="education" class="card-section animated-section" data-animate="cascade">
          <h4>Education</h4>
          <ul>
        ...
        <!-- Awards -->
        <div id="awards" class="card-section animated-section" data-animate="cascade">
          <h4>Awards</h4>
          <ul>
      ...
      <!-- Sidebar -->
      <div class="col-lg-4" id="skills-sticky">
